...
public class MainActivity extends AppCompatActivity {
    ...
    private FirestoreRecyclerAdapter setUpAdapter(FirebaseFirestore db)
    {
        ...
        FirestoreRecyclerAdapter adapter = new FirestoreRecyclerAdapter<Contact,ContactViewHolder>(options)
        {
            ...
            //We added new fields to display on the holder
            @Override
            public void onBindViewHolder(ContactViewHolder holder, int position, final Contact model)
            {
                ...
                holder.businessNumber.setText(model.businessNumber);//need to update all necessary
                holder.business.setText(model.business);//layout files
                holder.address.setText(model.address);
                holder.provinceOrTerritory.setText(model.provinceOrTerritory);
